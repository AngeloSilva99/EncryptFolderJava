...
public class Desencriptacao {
    ...
    public static void reconstruirDiretorioCompleto(String arquivounico, DiretorioSerializado diretorioSerializado, Path arquivoSerializado, String diretorioDestino) throws IOException, ClassNotFoundException {
        ...
        System.out.println("Diretório completo reconstruído com sucesso em: " + diretorio.getPath());
    }
	...
	public static void decryptFolder(String arquivounico, String arquivoSerializado, String diretorioDestino) {
        ...
        try {
            ...
            System.out.println(pastaTemporaria);

            // Mover o arquivo .ser para a pasta temporária
            Path arquivoTemporariocopiar = pastaTemporaria.resolve("lockedData.enc");
            Files.move(Paths.get(arquivoSerializado), arquivoTemporariocopiar, StandardCopyOption.REPLACE_EXISTING);
            ...
            if (!Files.exists(arquivoTemporario) || Files.size(arquivoTemporario) == 0) {
            	...
            	// Desserializar e reconstruir o diretório
                DiretorioSerializado diretorioSerializado = desserializarDiretorioCompleto(arquivoTemporario);
                reconstruirDiretorioCompleto(arquivounico, diretorioSerializado, arquivoTemporario, diretorioDestino);
